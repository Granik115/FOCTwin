...
Этот пререлиз исправляет ложную токовую аварию и сохраняет простой локальный рабочий цикл
«файл → приложение → мотор → файлы результата»:
...
циклов и вычислений в версии 0.5.0b2 нет.

## Установка готовой Windows-сборки

Откройте [GitHub Releases](https://github.com/Granik115/FOCTwin/releases), раскройте **Assets** у
`v0.5.0b2` и скачайте `FOCTwin-0.5.0b2-windows-x64.zip`. Распакуйте архив целиком и запустите
...
```powershell
git clone --branch release/v0.5.0b2 --single-branch https://github.com/Granik115/FOCTwin.git
cd FOCTwin
py -3.10 -m venv .venv
