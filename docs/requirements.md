...
Базовые требования сформированы 2026-07-19; файловый цикл программ уточнён для 0.5.0b3.
...
- В 0.5.0b3 отсутствуют переменные, выражения, условия, циклы и автоматический удалённый запуск.
...
- Последний существующий проект открывается после перезапуска, а диалог помнит его каталог.
